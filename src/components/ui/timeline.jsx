...
export const Timeline = ({ data }) => {
  ...
  return (
    <div
      className="w-full bg-zinc-950 font-['EB_Garamond',_serif] md:px-10"
      ref={containerRef}
    >
        ...
        {data.map((item, index) => (
          <div
            ...
            className={`flex justify-start md:gap-10 ${
              index === 0 ? "pt-10 md:pt-12" : "pt-20 md:pt-40"
            }`}
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs md:w-auto lg:max-w-[150px]">
              ...
              <h3 className="hidden md:block text-xl md:pl-20 md:text-4xl font-bold text-zinc-500 ">
                {item.title}
              </h3>
            </div>
