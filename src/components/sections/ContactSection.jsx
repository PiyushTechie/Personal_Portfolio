          ...
          <div className="lg:col-span-1 space-y-6">
            <SpotlightCard className="group">
              <div className="p-6 bg-zinc-900/50 backdrop-blur-sm rounded-xl border border-zinc-800 hover:border-sky-500/50 transition-all duration-300">
                ...
                <a href="mailto:piyushprajapati7120@gmail.com" className="text-zinc-300 text-sm hover:text-sky-400 transition-colors break-all">
            ...
            <SpotlightCard className="group">
              <div className="p-6 bg-zinc-900/50 backdrop-blur-sm rounded-xl border border-zinc-800 hover:border-sky-500/50 transition-all duration-300">
                ...
                <a href="tel:+919920694680" className="text-zinc-300 text-sm hover:text-sky-400 transition-colors">
                  +91-9920694680
                </a>
              </div>
            </SpotlightCard>
            ...
            <SpotlightCard className="h-full">
              <div className="p-8 md:p-10 bg-zinc-900/50 backdrop-blur-sm rounded-2xl border border-zinc-800 h-full">
                ...
                <form ref={formRef} onSubmit={formik.handleSubmit} className="space-y-5" noValidate>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input 
                        ...
                        className={`w-full bg-zinc-950/50 border rounded-xl px-4 py-3.5 text-white placeholder:text-zinc-600 focus:outline-none focus:ring-1 transition-all
                  ...
                  <div>
                    <label className="block text-sm font-medium text-zinc-300 mb-2">Your Message</label>
                    <textarea 
                      name="message"
                      rows={6}
                      ...
                      onChange={formik.handleChange}
                      onBlur={formik.handleBlur}
                      className={`w-full bg-zinc-950/50 border rounded-xl px-4 py-3.5 text-white placeholder:text-zinc-600 focus:outline-none focus:ring-1 transition-all resize-none
